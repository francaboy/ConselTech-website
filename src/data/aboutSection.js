...
export const aboutSectionOne = {
  image1,
  image2,
  title: "Bostäder och kommersiella\n eltjänster",
  text1:
    "Vår expertis sträcker sig över både bostäder och kommersiella verksamheter, där vi levererar omfattande eltjänster för att möta varje unikt behov.",
  text2:
    "I bostadsprojekt fokuserar vi på att skapa säkra och effektiva elinstallationer för att förbättra boendemiljön. För kommersiella kunder strävar vi efter att optimera energieffektivitet och säkerhet, samtidigt som vi skapar lösningar som främjar verksamhetens framgång. Oavsett om det är nyinstallationer, underhåll eller uppgraderingar, vårt dedikerade team av erfarna elektriker arbetar med precision och noggrannhet för att säkerställa högsta kvalitet och tillfredsställelse hos våra kunder. Lita på oss för pålitliga och skräddarsydda eltjänster som möter de högsta standarderna både för bostäder och kommersiella ändamål.",
  textList: [
    "Expertis.",
